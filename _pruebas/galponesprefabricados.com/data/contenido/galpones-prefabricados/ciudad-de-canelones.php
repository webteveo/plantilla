<?php
/** Contenido de /galpones-prefabricados/ciudad-de-canelones (servicio principal × capital departamental). */
return [
    'title'       => 'Canelones (ciudad): galpones prefabricados – Ruta 5 y 11',
    'description' => 'Galpones prefabricados en la ciudad de Canelones para depósito, acopio y maquinaria de chacra. Presupuesto por WhatsApp; llegamos por Ruta 5 y 11.',
    'h1'          => 'Galpones prefabricados en Canelones (ciudad): presupuesto a medida',
    'eyebrow'     => 'Galpones metálicos en la capital de Canelones',
    'subtitulo'   => 'Fabricamos la estructura en taller y la montamos en tu predio de la ciudad de Canelones o de sus chacras. Coordinamos la visita para relevar medidas por WhatsApp.',
    'secciones'   => [
        [
            'h2'       => 'Galpones prefabricados en Canelones (ciudad): cómo trabajamos',
            'parrafos' => [
                'Galpones Prefabricados construye galpones prefabricados en la ciudad de Canelones y en las chacras que la rodean, a unos 45 km de Montevideo por Ruta 5. Relevamos medidas, uso y terreno, te pasamos un presupuesto detallado por ítem y montamos en obra la estructura metálica fabricada en taller. Escribinos por WhatsApp y coordinamos la visita.',
                'Al ser la capital departamental, acá conviven dos tipos de pedido: el depósito o local comercial dentro del casco urbano, cerca de la Plaza Tomás Berreta, y el galpón rural en las chacras y viñedos de la periferia, sobre Ruta 5, Ruta 11 y los caminos hacia Juanicó y Los Cerrillos.',
            ],
        ],
        [
        ...
        [
            'h2'       => 'Qué define el precio de un galpón en Canelones (ciudad)',
            'parrafos' => [
                'El presupuesto se arma ítem por ítem; en la ciudad de Canelones lo mueven sobre todo estos factores:',
            ],
            'lista'    => [
                'Medidas y altura libre: un tractor con acoplado necesita más portón que un depósito de cajones.',
                'Cerramientos: solo techo, cerrado con chapa, o con muro bajo de bloque y chapa arriba.',
                'Platea o fundaciones: según el suelo y el peso que va a soportar el piso.',
                'Acceso del camión y la grúa: un camino de chacra angosto puede exigir piezas más cortas.',
                'Permiso de construcción ante la Intendencia de Canelones y honorarios del técnico que firma los planos.',
            ],
            'parrafos_despues' => [
                'El plazo de fabricación y montaje también se define en el presupuesto, según medidas y terreno.',
            ],
        ],
        [
