...
return [
    ...
    'secciones'   => [
        ...
        [
            'h2'       => 'Cómo llegamos y qué encontramos en Bañados de Carrasco',
            'parrafos' => [
                'Entramos por Camino Carrasco o por Avenida Cochabamba desde el lado de Carrasco Norte, y por Ruta 8 desde el norte. La mayoría de los predios son casas con terreno grande, chacras y algunos depósitos, con calles internas de balasto en varios tramos. El nombre del barrio lo dice: hay sectores bajos cerca del arroyo, con napa alta, y eso pesa en el cálculo de las fundaciones.',
                'Del otro lado del arroyo está Paso Carrasco, ya en Canelones, y hacia el norte Punta de Rieles y Villa García. Cubrimos esos vecinos desde acá: <a href="/galpones-prefabricados/paso-carrasco">galpones metálicos en Paso Carrasco</a>, <a href="/galpones-prefabricados/punta-de-rieles">galpones prefabricados en Punta de Rieles</a> y <a href="/galpones-prefabricados/villa-garcia">galpones para chacras en Villa García</a>.',
            ],
        ],
        [
            'h2'       => 'Qué define el precio de un galpón en Bañados de Carrasco',
            'parrafos' => [
                'Sin cifras genéricas: cada galpón prefabricado en Bañados de Carrasco se cotiza con los datos del predio. Estos son los factores que más mueven el número:',
            ],
            'lista' => [
                'Medidas y altura libre: definen la cantidad de pórticos y el peso de la estructura.',
                'Platea y fundaciones: en suelo bajo o con relleno pueden pedir más profundidad, y es el ítem que más varía dentro del barrio.',
                'Cerramientos: galpón cerrado con chapa, semicerrado o tinglado abierto.',
                'Accesos: si el camión descarga en el frente o hay que mover piezas a mano hasta el fondo.',
                'Permiso de construcción y planos ante la Intendencia de Montevideo.',
            ],
            'parrafos_despues' => [
                'Te mandamos el presupuesto por WhatsApp con cada ítem separado.',
            ],
        ],
        [
            'h2'       => 'Permisos y trámites en Bañados de Carrasco',
            'parrafos' => [
                'El barrio pertenece a Montevideo: el permiso de construcción se tramita en la Intendencia de Montevideo con planos firmados por técnico. En predios cercanos al arroyo conviene consultar antes si hay alguna restricción por zona inundable; te orientamos sobre qué preguntar y con qué documentación. Para ver qué más hacemos en el barrio, entrá a <a href="/banados-de-carrasco">todo lo que hacemos en Bañados de Carrasco</a>.',
            ],
        ],
    ],
    'faq' => [
