...
return [
    ...
    'secciones'   => [
        [
            'h2' => 'Galpones prefabricados en Montes: cómo trabajamos',
            'parrafos' => [
                'Galpones Prefabricados construye galpones metálicos en Montes y en los campos que la rodean, en el extremo sureste de Canelones, donde Ruta 80 se desprende de Ruta 8. Relevamos el predio, presupuestamos estructura, techo, cerramientos, platea y montaje por separado, fabricamos en taller y montamos en obra. Escribinos por WhatsApp con las medidas y el uso, y coordinamos la visita.',
                'La ventaja de Montes es el acceso: Ruta 8 es una ruta principal, apta para el camión que trae la estructura, y desde ahí el tramo por Ruta 80 hasta el pueblo es corto. Lo que más se pide son galpones para maquinaria y acopio, y algún depósito cerrado para emprendimientos rurales.',
            ],
        ],
        [
            'h2' => 'Cómo llegamos y qué encontramos en Montes',
            'parrafos' => [
                'Salimos por Ruta 8 hacia el este, pasando Pando y Soca, y tomamos Ruta 80 hasta Montes. Ruta 80 sigue después hacia Migues, así que desde una misma salida cubrimos los predios de las dos localidades. En el relevamiento miramos el camino de entrada al campo y dónde se puede descargar la estructura cerca del punto de montaje.',
                'Alrededor de Montes hay campo ganadero y chacras, con predios grandes y pocos vecinos linderos, lo que simplifica la ubicación del galpón y los retiros. Los suelos varían: en zonas bajas cerca de arroyos hay que prestar atención al escurrimiento y a la fundación. Atendemos también los <a href="/galpones-prefabricados/migues">galpones prefabricados en Migues</a>, los <a href="/galpones-prefabricados/tala">galpones agrícolas en Tala</a> y los <a href="/galpones-prefabricados/soca">galpones en Soca</a>, y podés ver la cobertura completa en <a href="/montes">nuestra página de Montes</a>.',
            ],
        ],
        [
            ...
            'lista' => [
                ...
                'Tinglado abierto para acopio de rollos y fardos, con aleros amplios.',
                'Depósito cerrado para raciones, semillas y agroquímicos con piso de hormigón.',
                'Galpón para emprendimiento rural: elaboración, fraccionado o packing chico.',
