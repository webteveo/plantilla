    ...
    'secciones' => [
        ...
        [
            ...
            'lista' => [
                ...
                'Talleres mecánicos, gomerías y talleres de camiones con portón corredizo al frente.',
                'Galpones para pequeñas fábricas y carpinterías metálicas.',
                'Depósitos de fletes y mudanzas que usan Ruta 5 como salida.',
        ...
        [
            'h2' => 'Qué define el precio de un galpón en Colón',
            'parrafos' => [
                'Sin ver el predio no damos cifras, pero sí te decimos qué mueve el presupuesto: las medidas y la altura libre, el tipo de cerramiento y aberturas, la platea o las bases, y sobre todo el acceso. En Colón muchos galpones van al fondo de un local, y si el pasaje es angosto se fabrican piezas más cortas o se iza desde la calle; eso se define en la visita. El permiso es de la Intendencia de Montevideo, con planos firmados. Otros servicios en el barrio, en <a href="/montevideo">Montevideo</a>; el resto de la capital, en <a href="/galpones-prefabricados/montevideo">galpones prefabricados en toda Montevideo</a>.',
            ],
        ],
    ],
