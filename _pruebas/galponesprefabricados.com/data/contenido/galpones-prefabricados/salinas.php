...
return [
    ...
    'secciones'   => [
        ...
        [
            'h2' => 'Cómo llegamos y qué encontramos en Salinas',
            'parrafos' => [
                'Llegamos por la Ruta Interbalnearia, a unos 40 km de Montevideo, con acceso directo desde la ruta a las calles del balneario. La parte sur, hacia la Rambla de Salinas, tiene calles de arena y balasto entre pinos; Salinas Norte, del otro lado de la Interbalnearia, es más abierta y con predios más grandes. Con el camión de la estructura evaluamos por qué calle entrar y dónde descargar sin quedar enterrados en la arena.',
                'Los terrenos son arenosos y muchos con pinos que hay que respetar o retirar antes de montar. La platea o las bases se calculan para ese suelo, y la chapa y la estructura van con protección contra el ambiente salino. En la misma franja atendemos <a href="/galpones-prefabricados/atlantida">galpones prefabricados en Atlántida</a> y <a href="/galpones-prefabricados/ciudad-de-la-costa">galpones metálicos en Ciudad de la Costa</a>. La cobertura completa está en la página de <a href="/salinas">Salinas</a>.',
            ],
        ],
        [
            ...
            'lista' => [
                ...
                'Depósito de materiales para constructores y sanitarios que trabajan en la Costa de Oro.',
                'Galpón para comercio o distribuidora sobre la Interbalnearia o en Salinas Norte.',
                'Taller mecánico o de motos con altura para elevador.',
        ...
        [
            'h2' => 'Permisos y trámites en Salinas',
            'parrafos' => [
                'Salinas es parte del departamento de Canelones y el permiso de construcción se gestiona en la Intendencia de Canelones, en línea y con técnico registrado. En zona balnearia conviene revisar los retiros del padrón y las normas sobre arbolado antes de definir la ubicación. Te orientamos con la documentación del galpón para que el técnico presente los planos.',
            ],
        ],
    ],
    'faq' => [
