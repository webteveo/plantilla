    ...
    'secciones' => [
        ...
        [
            ...
            'lista' => [
                ...
                'Galpones para hortifruticultura y guardado de maquinaria en Manga Rural y Toledo Chico.',
                'Talleres mecánicos y de camiones sobre Belloni y Mendoza.',
                'Depósitos de materiales y corralones para la construcción del noreste de la capital.',
                'Galpones en fondos de casas para herramientas, vehículos o un emprendimiento.',
            ],
            'parrafos_despues' => [
                'Para un predio productivo mirá <a href="/galpones-agricolas">galpones para chacras</a>.',
            ],
        ],
        [
            'h2' => 'Qué define el precio de un galpón en Manga',
            'parrafos' => [
                'El presupuesto se arma por ítem: estructura, techo, cerramientos, platea o bases, portones y montaje. Lo que más lo mueve en Manga es el tamaño y la altura, si el galpón va cerrado o abierto, el estado del suelo (los bajos cerca de las cañadas piden más fundación) y el acceso por camino de balasto en la parte rural. El permiso lo tramita la Intendencia de Montevideo con planos firmados, tanto en la zona urbana como en suelo rural. Otros servicios en el barrio, en <a href="/montevideo">servicios de Montevideo</a>; los demás barrios, en <a href="/galpones-prefabricados/montevideo">galpones en el resto de Montevideo</a>.',
            ],
        ],
    ],
