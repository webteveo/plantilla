...
return [
    ...
    'secciones'   => [
        ...
        [
            'h2'       => 'Cómo llegamos y qué encontramos en San Antonio',
            'parrafos' => [
                'Desde Montevideo se llega por Ruta 5 hasta la ciudad de Canelones y después por Ruta 11 hacia el este, o por Ruta 6 y el empalme con Ruta 11. En total son poco más de 50 km. Los predios están sobre la ruta o sobre caminos vecinales cortos, con buen acceso para el camión con la estructura.',
                'El paisaje es de lomas bajas con suelo firme, chacras de hortifruticultura, algunos viñedos y granjas avícolas. Los galpones más pedidos son los de maquinaria e implementos, los de acopio de cajones y fertilizantes, y los galpones para cría con ventilación controlada.',
                'Por Ruta 11 seguimos hacia <a href="/galpones-prefabricados/santa-rosa">Santa Rosa y sus granjas</a> y hacia <a href="/galpones-prefabricados/san-bautista">galpones prefabricados en San Bautista</a>; del otro lado, hacia <a href="/galpones-prefabricados/ciudad-de-canelones">la ciudad de Canelones</a>.',
            ],
        ],
        [
            'h2'       => 'Usos típicos de galpones en San Antonio',
            'parrafos' => [
                'Lo que más se construye en San Antonio, y qué cambia en cada caso:',
            ],
            'lista'    => [
                'Galpón para maquinaria agrícola: tractor, pulverizadora y acoplado bajo techo, con portón alto y piso de hormigón.',
                'Depósito de insumos y acopio: fertilizantes, cajones y semilla, cerrado con chapa y bien ventilado.',
                'Galpón avícola: largo y con aberturas laterales para ventilación, según el sistema de cría.',
