...
return [
    ...
    'secciones'   => [
        ...
        [
            ...
            'parrafos' => [
                'Llegamos por Ruta 7, que une Tala con Montevideo pasando por San Jacinto, o por Ruta 12 desde San Ramón. Las estructuras viajan en camión desde el taller, así que en la visita miramos el camino de entrada al predio, los portones y el espacio para descargar y armar. En caminos vecinales de tosca conviene coordinar el montaje con días secos.',
                'Los predios en Tala son variados: solares en el centro, quintas en los bordes de la ciudad y chacras y campos con caminos internos. En campo suele hacer falta platea o bases aisladas nuevas; en un solar urbano a veces hay que resolver el retiro frontal y el escurrimiento hacia la calle. Cubrimos también <a href="/galpones-prefabricados/san-ramon">galpones prefabricados en San Ramón</a>, <a href="/galpones-prefabricados/migues">depósitos rurales en Migues</a> y <a href="/galpones-prefabricados/montes">estructuras metálicas en Montes</a>, y todo lo que resumimos en la página de <a href="/tala">servicios en Tala</a>.',
            ],
        ],
        [
            ...
            'lista' => [
                ...
                'Acopio de fardos y forraje con buena ventilación y aleros para descargar bajo techo.',
                'Depósito de insumos y herramientas en chacras hortícolas y de cría.',
                'Taller mecánico o de reparación de maquinaria agrícola.',
                'Depósito para comercio o distribuidora en el casco urbano de Tala.',
            ],
            'parrafos_despues' => [
                'Para los usos de campo tenemos una página específica de <a href="/galpones-agricolas">galpones agrícolas</a> con más detalle sobre portones, ventilación y acopio.',
            ],
        ],
        [
