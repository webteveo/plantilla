...
return [
    ...
    'secciones'   => [
        ...
        [
            'h2'       => 'Cómo llegamos y qué encontramos en Punta de Rieles',
            'parrafos' => [
                'Se llega por Camino Maldonado, que es la Ruta 8 dentro de Montevideo, y por la conexión con la Ruta 102 hacia el aeropuerto. Eso facilita la entrada del camión con las piezas y del equipo de montaje. Sobre la ruta hay frentes comerciales; hacia adentro, casas con terreno, quintas y predios amplios donde entra un galpón mediano sin problemas.',
                'La referencia más conocida del barrio es el antiguo penal de Punta de Rieles, y hacia el este empieza la zona semirrural de Villa García. Trabajamos también en los alrededores: hacemos <a href="/galpones-prefabricados/banados-de-carrasco">galpones en Bañados de Carrasco</a>, <a href="/galpones-prefabricados/villa-garcia">depósitos prefabricados en Villa García</a> y <a href="/galpones-prefabricados/manga">estructuras metálicas en Manga</a>.',
            ],
        ],
        [
            'h2'       => 'Usos típicos de galpones en Punta de Rieles',
            'parrafos' => [
                'Por su ubicación sobre Ruta 8, los galpones prefabricados en Punta de Rieles son casi siempre galpones de trabajo. Los pedidos más comunes:',
            ],
            'lista' => [
                'Taller mecánico o de chapa y pintura con portón corredizo para entrar vehículos.',
                'Depósito de materiales o de mercadería para comercios de Camino Maldonado.',
                'Galpón para guardar camionetas, fletes y herramientas en casas con terreno.',
                'Galpón chico para emprendimientos: carpintería, herrería, imprenta.',
        ...
        [
            'h2'       => 'Permisos y trámites en Punta de Rieles',
            'parrafos' => [
                'Punta de Rieles es Montevideo, así que el permiso de construcción se gestiona ante la Intendencia de Montevideo, con planos firmados por un técnico. Antes de fabricar te orientamos sobre qué documentación pide el trámite y qué conviene resolver primero, como el retiro respecto de la calle y la platea. Para otros trabajos en el barrio, mirá <a href="/punta-de-rieles">otros servicios en Punta de Rieles</a>.',
            ],
        ],
    ],
    'faq' => [
