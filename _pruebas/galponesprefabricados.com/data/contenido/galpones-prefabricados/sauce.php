...
return [
    ...
    'secciones'   => [
        [
            'h2' => 'Galpones prefabricados en Sauce: cómo trabajamos',
            'parrafos' => [
                'Galpones Prefabricados construye galpones de estructura metálica en Sauce, una ciudad rodeada de viñedos, granjas y chacras hortícolas sobre Ruta 33, a unos 35 km de Montevideo. Relevamos el predio, presupuestamos estructura, techo, cerramientos, platea y montaje por separado, y coordinamos todo por WhatsApp. La estructura se fabrica en taller y se monta en obra, con menos días de trabajo en el terreno.',
                'Acá conviven dos tipos de cliente: el productor que necesita un galpón para maquinaria, packing o bodega chica, y el comercio o taller del casco urbano que necesita depósito. Cada uno tiene medidas, alturas y cerramientos distintos.',
            ],
        ],
        [
            'h2' => 'Cómo llegamos y qué encontramos en Sauce',
            'parrafos' => [
                'Desde Montevideo se llega por Ruta 6 y luego Ruta 33, o desde Pando por la misma Ruta 33 hacia el norte. Las dos son rutas aptas para el camión con la estructura. Sauce está a mitad de camino entre la zona industrial de Pando y la capital departamental, con caminos vecinales que salen hacia las chacras y viñedos.',
                'Los predios rurales son chacras de tamaño mediano, muchas con viñedo, invernáculos o frutales, donde el galpón suele ir cerca de la casa o del ingreso para facilitar la carga. En el casco urbano hay solares con frente a calle y algún retiro que respetar. Atendemos también <a href="/galpones-prefabricados/pando">galpones para la zona industrial de Pando</a>, <a href="/galpones-prefabricados/santa-rosa">galpones prefabricados en Santa Rosa</a> y <a href="/galpones-prefabricados/joaquin-suarez">galpones metálicos en Joaquín Suárez</a>. La página de <a href="/sauce">Sauce</a> reúne todos los servicios de la zona.',
            ],
        ],
        [
            ...
            'lista' => [
                ...
                'Depósito para bodega chica o viñedo: cajones, insumos y maquinaria de viña.',
                'Cubierta para tractor, pulverizadora y carros, con portón alto.',
                'Depósito de comercio o distribuidora en el centro de Sauce.',
        ...
        [
            'h2' => 'Permisos y trámites en Sauce',
            'parrafos' => [
                'El permiso de construcción lo otorga la Intendencia de Canelones mediante un trámite en línea que presenta un técnico registrado. Vale para el casco urbano de Sauce y para las chacras de la zona rural. Te pasamos la memoria y las medidas del galpón para los planos y te orientamos sobre el trámite antes de fabricar.',
            ],
        ],
    ],
    'faq' => [
