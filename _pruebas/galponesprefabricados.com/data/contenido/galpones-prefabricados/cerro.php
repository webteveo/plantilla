...
return [
    ...
    'secciones' => [
        [
            'h2' => 'Galpones prefabricados en el Cerro: cómo trabajamos',
            'parrafos' => [
                'Galpones Prefabricados hace galpones de estructura metálica en el Cerro, el barrio del oeste de Montevideo que rodea la Fortaleza y mira a la bahía. Fabricamos la estructura en taller y la montamos en tu predio, sea un taller sobre Grecia, un depósito hacia Camino Cibils o un galpón en la zona portuaria. Se coordina por WhatsApp: medidas, uso y ubicación, y te llega el presupuesto detallado por ítem.',
                'El Cerro creció alrededor de los frigoríficos y conserva predios industriales grandes junto a la rambla. Hoy muchos se reconvierten en depósitos, talleres mecánicos y logística vinculada al puerto y a Punta de Sayago. Para eso sirve un <a href="/galpones-prefabricados">galpón prefabricado a medida</a>: se adapta al predio que ya tenés y se amplía después.',
            ],
        ],
        [
        ...
        [
            'h2' => 'Usos típicos de galpones en el Cerro',
            'parrafos' => [
                'En el Cerro el galpón es una herramienta de trabajo. Lo más pedido:',
            ],
            'lista' => [
                'Talleres mecánicos y de chapa y pintura con portón corredizo al frente.',
                'Depósitos de mercadería para comercios de Grecia y alrededores.',
                'Naves para logística y acopio en predios industriales cercanos al puerto.',
                'Galpones para pesca artesanal y guardado de embarcaciones y equipos junto a la playa.',
                'Cubiertas para flotas de camionetas o camiones.',
            ],
            'parrafos_despues' => [
                'Si querés solo techo sin laterales, un <a href="/tinglados">tinglado sin cerramiento</a> resuelve el guardado de vehículos con menos obra.',
            ],
        ],
        [
            'h2' => 'Permisos y trámites en el Cerro',
            'parrafos' => [
                'El permiso de construcción se tramita ante la Intendencia de Montevideo, con planos firmados por un arquitecto o ingeniero. En predios con frente a la rambla o cerca de la Fortaleza puede haber condiciones de altura o retiro; te orientamos y adaptamos el diseño a lo que se apruebe. Si necesitás otro servicio en la zona, mirá <a href="/montevideo">todo lo que hacemos en Montevideo</a>.',
            ],
        ],
    ],
