    ...
    'secciones'   => [
        ...
        [
            ...
            'lista'    => [
                ...
                'Medidas: ancho, largo y altura libre bajo viga, con el implemento más alto como referencia.',
                'Cerramientos: solo techo, laterales parciales o cerramiento total con chapa y aislación.',
                'Platea: espesor y armadura según el peso que soporte el piso.',
                'Acceso: distancia por camino vecinal y espacio para el camión y la grúa dentro del predio.',
                'Permiso de construcción y técnico que firma los planos.',
            ],
            'parrafos_despues' => [
                'Los plazos de fabricación y montaje también se fijan en el presupuesto, según medidas y terreno. Qué incluye cada ítem está en <a href="/galpones-prefabricados">galpones prefabricados: qué cotizamos y cómo</a>.',
            ],
        ],
        [
            'h2'       => 'Permisos y trámites en San Jacinto',
            'parrafos' => [
                'El galpón necesita permiso de construcción de la Intendencia de Canelones, tramitado en línea con un técnico registrado. En predios rurales grandes conviene definir la ubicación exacta antes de pedir el permiso, porque los planos la incluyen. Te orientamos y coordinamos con tu técnico. Todo lo que hacemos en la localidad, en <a href="/san-jacinto">San Jacinto</a>.',
            ],
        ],
    ],
    'faq' => [
