...
return [
    ...
    'secciones'   => [
        ...
        [
            'h2' => 'Cómo llegamos y qué encontramos en Montevideo',
            'parrafos' => [
                'Los predios industriales de Montevideo están pegados a los accesos: Ruta 1 y Camino Cibils hacia el Cerro y Paso de la Arena, Ruta 5 con la zona de Peñarol y Sayago, y Ruta 8 con Camino Carrasco hacia el este, donde queda Zonamerica y el anillo de la Ruta 102. Son padrones con frente a calle pavimentada, muchas veces entre construcciones existentes, y eso obliga a planificar el ingreso de los camiones con la estructura y el lugar de la grúa de montaje.',
                'Lo que más se pide acá son depósitos logísticos con altura para racks, naves para talleres metalúrgicos o de mantenimiento de flota y ampliaciones de plantas que ya funcionan. Por la misma Ruta 8 seguimos hacia las <a href="/galpones-industriales/colonia-nicolich">naves logísticas en Colonia Nicolich</a> y <a href="/galpones-industriales/barros-blancos">Barros Blancos</a>; por Ruta 5 llegamos a los <a href="/galpones-industriales/las-piedras">galpones industriales en Las Piedras</a>.',
            ],
        ],
        [
            ...
            'lista' => [
                ...
                'Cargas especiales: puente grúa, estanterías altas, equipos colgados de la estructura.',
    ...
    'faq' => [
        ...
        [
            ...
            'a' => 'En general sí: el permiso de construcción habilita la obra y la actividad industrial tiene su propia habilitación municipal. Te orientamos sobre qué pide cada trámite en Montevideo, siempre con tu técnico responsable.',
        ],
    ],
