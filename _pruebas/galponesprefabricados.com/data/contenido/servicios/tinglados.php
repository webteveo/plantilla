...
return [
    ...
    'secciones' => [
        [
            'h2' => '¿Qué es un tinglado y para qué se usa?',
            'parrafos' => [
        ...
        [
            'h2' => '¿Cómo se construye un tinglado metálico?',
            'parrafos' => [
                'La estructura de un tinglado es más simple que la de un galpón cerrado, pero se calcula igual: sin laterales, el viento actúa por debajo del techo y las columnas y bases tienen que responder a eso. Estos son los pasos de fabricación y montaje:',
            ],
            'lista' => [
                'Relevamiento: qué se va a cubrir, altura libre que necesita, medidas del predio y por dónde entra el camión.',
                'Presupuesto por ítem: columnas y cabriadas, correas, chapa de techo, canalones y bajadas, bases de hormigón, laterales parciales si se piden.',
                'Proyecto y permiso ante la intendencia, con técnico responsable.',
                'Fabricación en taller: columnas, cabriadas y correas cortadas, armadas y pintadas.',
                'Bases de hormigón en obra, con los anclajes para cada columna.',
        ...
        [
            'h2' => '¿Qué define el precio de un tinglado?',
            'parrafos' => [
                'Un tinglado cuesta menos que un galpón de las mismas medidas porque no lleva cerramientos, pero el precio igual varía bastante entre un proyecto y otro. Estos son los factores que pesan en el presupuesto en Montevideo y Canelones:',
            ],
            'lista' => [
                'Superficie a cubrir y luz entre columnas: cubrir el ancho de una sola vez o con una fila de columnas intermedias.',
                'Altura libre: para autos alcanza con menos; para camiones o maquinaria agrícola hace falta más columna y más base.',
                'Pendiente y tipo de techo: a un agua, a dos aguas, con o sin canalón, con o sin iluminación cenital.',
                'Laterales parciales: un cortaviento en un lado o en dos cambia material y montaje.',
                'Bases de hormigón: dependen del suelo y de la altura del tinglado.',
    ...
    'faq' => [
        ['q' => '¿Se puede cerrar un tinglado más adelante y convertirlo en galpón?', 'a' => 'Sí, siempre que la estructura se haya calculado previendo el cerramiento. Se agregan correas laterales y chapa o bloque sobre las mismas columnas. Decinos al presupuestar si pensás cerrarlo en el futuro.'],
        ['q' => '¿Qué pendiente de techo lleva un tinglado?', 'a' => 'La suficiente para que la chapa escurra bien y no acumule agua; se define con la longitud del techo y el tipo de chapa. A un agua es más simple; a dos aguas reparte mejor la altura.'],
        ['q' => '¿Un tinglado aguanta el viento de la costa?', 'a' => 'Se calcula para eso. Sin paredes, el viento empuja el techo desde abajo, por lo que columnas, arriostramientos y bases se dimensionan para la zona. En balnearios de Canelones lo tenemos en cuenta en el presupuesto.'],
        ['q' => '¿Se puede adosar un tinglado a una construcción existente?', 'a' => 'Sí. Se apoya en columnas propias y se resuelve el encuentro con el techo existente para que no entre agua. Galpones Prefabricados revisa la construcción vecina en el relevamiento.'],
    ],
