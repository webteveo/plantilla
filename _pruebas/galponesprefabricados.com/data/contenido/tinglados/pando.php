...
return [
    ...
    'secciones'   => [
        [
            'h2' => '¿Qué tinglados hacemos en Pando?',
            'parrafos' => [
                'Galpones Prefabricados hace tinglados en Pando para empresas de la zona industrial de Ruta 8, transportistas y depósitos de materiales. Son techados abiertos o semicerrados de estructura metálica y chapa, fabricados en taller y montados en tu predio. Escribinos por WhatsApp con medidas aproximadas y uso; coordinamos la visita para relevar terreno y acceso de camiones.',
                'En Pando el tinglado suele acompañar a un galpón que ya existe: se agrega una playa techada para cargar bajo techo o para estacionar la flota. Si lo que necesitás es la nave cerrada, la <a href="/galpones-prefabricados/pando">página principal de galpones en Pando</a> explica cómo se cotiza.',
            ],
        ],
        [
        ...
        [
            'h2' => 'Qué define el precio de un tinglado en Pando',
            'parrafos' => [
                'Sin cifras fijas, porque cada techado es distinto. Lo que mueve el presupuesto:',
            ],
            'lista' => [
                'Altura libre: un techado para semirremolques necesita más columna y más cabriada que uno para camionetas.',
                'Luz entre columnas: cubrir una playa de carga sin apoyos intermedios exige cabriadas más pesadas.',
                'Cantidad de laterales cerrados: cero, uno o dos lados de chapa cambian el costo y la resistencia al viento.',
                'Bases: si el predio ya tiene piso de hormigón se anclan las columnas; si no, se hacen bases nuevas.',
                'Canalones y desagües: en playas grandes hay que evacuar bien el agua de lluvia para no inundar la maniobra.',
                'Permiso ante la Intendencia de Canelones y planos firmados por técnico.',
            ],
        ],
        [
